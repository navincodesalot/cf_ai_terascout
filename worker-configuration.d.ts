/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 572a09b26a6f2d46fb8a41ff2d95676d)
// Runtime types generated with workerd@1.20260205.0 2025-09-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "ScoutDO";
	}
	interface Env {
		AI: Ai;
		RESEND_API_KEY: string;
		SCOUT_DO: DurableObjectNamespace<import("./worker/index").ScoutDO>;
		SCOUT_WORKFLOW: Workflow<Parameters<import("./worker/index").ScoutWorkflow['run']>[0]['payload']>;
	}
}
